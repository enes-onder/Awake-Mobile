    ...
    quiz: [
      {
        ...
        options: [
          "Beğeni sayısına bakarak karar veririm",
          "Tersine görsel arama yaparım",
    ...
    quiz: [
      {
        ...
        options: [
          "Fotoğrafın dosya boyutu",
          "Fotoğrafın içindeki gizli metadata",
          "Fotoğrafın renk paleti",
          "Fotoğrafın çözünürlüğü",
        ],
        correctIdx: 1,
      ...
      },
      {
        ...
        options: [
          "Tüm platformlar EXIF'i korur",
          "Çoğu platform yükleme sırasında EXIF'i siler",
          "Sadece Twitter EXIF'i siler",
          "EXIF hiçbir zaman silinmez",
        ],
        correctIdx: 1,
    ...
    quiz: [
      {
        ...
        options: [
          "Haberi paylaşan bir Twitter kullanıcısı",
          "AFAD'ın resmi web sitesi",
          "WhatsApp grubundaki mesaj",
          "Haber yapan YouTube kanalı",
        ],
        correctIdx: 1,
      ...
      },
      {
        ...
        options: [
          "Güvenilirdir, okuyabilirim",
          "Resmi sitenin gerçek adresini doğrularım",
          "Beğeni sayısına bakarım",
          "Sadece başlığı okurum",
        ],
        correctIdx: 1,
    ...
    quiz: [
      {
        ...
        options: [
          ...
          "Eleştirel düşünceyi azaltarak hızlı yayılmak için",
          "Güzel görünmek için",
          "Daha uzun okunması için",
        ],
        correctIdx: 1,
      ...
      },
      {
        ...
        options: [
          "Hemen paylaşmalıyım, önemli olabilir",
          "Görmezden gelmeliyim",
          "Paylaşmadan önce bekleyip kaynağı kontrol etmeliyim",
          "Arkadaşlarıma sorup paylaşmalıyım",
        ],
        correctIdx: 2,
  ...
  },
  {
    ...
    quiz: [
      ...
      },
      {
        ...
        options: [
          "Google Çeviri",
          "aiornot.com gibi tespit araçları",
    ...
    quiz: [
      {
        ...
        options: [
          "Sahte bir fotoğraf oluşturmak",
          "Gerçek bir içeriği yanlış bir olay için kullanmak",
          "Haber başlığını değiştirmek",
          "Fotoğrafı düzenlemek",
        ],
        correctIdx: 1,
      ...
      },
      {
        ...
        options: [
          "Kaç kişi beğenmiş",
          "Plaka, tabela ve giysi tarzı gibi detaylar",
          "Fotoğrafın boyutu",
          "Yorumlar bölümü",
        ],
        correctIdx: 1,
